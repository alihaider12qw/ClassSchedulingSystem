...
namespace ClassSchedulingSystem.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TeacherID,Name,Password,Address,PhoneNo,CourseID")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherID,Name,Password,Address,PhoneNo,CourseID")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
