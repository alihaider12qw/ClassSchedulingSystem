...
namespace ClassSchedulingSystem.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,Name,Password,Address,PhoneNo,CourseId,Department")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,Name,Password,Address,PhoneNo,CourseId,Department")] Student student)
        {
            if (ModelState.IsValid)
            {
